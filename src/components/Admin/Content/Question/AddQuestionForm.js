...
const QuizQuestionForm = (props) => {
    ...
    const addAnswerOption = () => {
        ...
        updatedQuestions[currentQuestionIndex] = {
            ...updatedQuestions[currentQuestionIndex],
            answers: [...updatedQuestions[currentQuestionIndex].answers, { text: "", isCorrect: false }],
        }
        setQuestions(updatedQuestions)
    }
    ...
    for (let i = 0; i < questions.length; i++) {
        paginationItems.push(
            <Pagination.Item key={i} active={i === currentQuestionIndex} onClick={() => goToQuestion(i)}>
                {i + 1}
            </Pagination.Item>,
        )
    }
            ...
            <Card className="mx-auto mb-4" style={{ maxWidth: "1000px" }}>
                ...
                <Card.Body>
                    ...
                    <Form.Group className="mb-4">
                        <Form.Label><b>Select Quiz</b></Form.Label>
                        <Form.Select value={selectedQuiz} onChange={(e) => setSelectedQuiz(e.target.value)}>
                    ...
                    <div className="d-flex justify-content-between mb-4">
                        <Button variant="primary" onClick={addNewQuestion} className="d-flex align-items-center gap-2">
                            <FaPlus /> Add New Question
                        </Button>

                        <Button variant="success" onClick={saveAllQuestions} className="d-flex align-items-center gap-2">
                                        ...
                                        <div className="d-flex justify-content-center mb-3">
                                            {!currentQuestion.image ? (
                                                ...
                                                <div className="position-relative" style={{ width: "200px", height: "200px" }}>
                                                    <img
                                                        src={URL.createObjectURL(currentQuestion.image) || "/placeholder.svg"}
                                                    ...
                                                    <Button
                                                        ...
                                                        style={{ top: "-10px", right: "-10px", borderRadius: "50%", padding: "0.5rem 0.5rem" }}
                                                        onClick={removeImage}
                                                    >
                                                        <FaTimes size={12} />
                                                    </Button>
                                            ...
                                            <div key={index} className="d-flex align-items-start mb-2 gap-2">
                                                ...
                                                {currentQuestion.answers.length > 2 && (
                                                    <Button variant="danger" size="sm"
                                                        ...
                                                        style={{ borderRadius: "50%", padding: "0.5rem 0.5rem", marginTop: "0.25rem" }}
                    ...
                    <div className="d-flex justify-content-center">
                        <Pagination>
                            <Pagination.Prev onClick={goToPreviousQuestion} disabled={currentQuestionIndex === 0} />
                            {paginationItems}
                            <Pagination.Next onClick={goToNextQuestion} disabled={currentQuestionIndex === questions.length - 1} />
                        </Pagination>
                    </div>
